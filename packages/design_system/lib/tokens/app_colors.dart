...
class AppColors {
  ...
  static const Color primaryAccent = Color(0xFF6366F1); // Electric Indigo / Violet
  ...
  static const Color darkSurfaceBase = Color(0xFF12141A); // Ground Level / Navigation
  static const Color darkSurfaceElevated = Color(0xFF1A1D26); // Cards, Drawers
  static const Color darkSurfaceActive = Color(0xFF222634); // Active / Hovered rows
  static const Color darkBorderSubtle = Color(0xFF202430); // Hairline dividers (1px)
  ...
  static const Color darkTextTertiary = Color(0xFF64748B); // Low emphasis / captions
  ...
  static const Color lightSurfaceBase = Color(0xFFFFFFFF); // Pure White Elevated
  static const Color lightSurfaceElevated = Color(0xFFF1F3F7); // Secondary container
  static const Color lightSurfaceActive = Color(0xFFE5E8F0); // Selected row
  static const Color lightBorderSubtle = Color(0xFFE2E4EC); // Soft dividers (1px)
